  ...
  <div class="container">
    ...
    <section class="section border-top border-bottom">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-4">
            <h2 class="section-heading">Testimoni Peserta Gypem</h2>
          </div>
        </div>
...
<!-- ======= Footer ======= -->
<footer class="footer" role="contentinfo" id="footer"> <!-- Added id "footer" -->
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7 ms-auto">
            <div class="row site-section pt-0">
              <div class="col-md-6 mb-4 mb-md-0">
                ...
                <p class="mb-0"><strong>Lokasi:</strong> Jl. Citarung, No. 23, Jakarta</p>
              </div>
              <div class="col-md-6 mb-4 mb-md-0">
                <h3>Alamat</h3>
                <p class="mb-0">Jl. Citarung, No. 23<br> Jakarta, Indonesia</p>
          </div>
          <div class="col-md-6 mb-4 mb-md-0">
            <h3>Sosial Media</h3>
            <div class="social">
